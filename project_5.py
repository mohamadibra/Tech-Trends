...
if selected_section == "Executive Summary":
    ...
    fig.update_layout(dragmode=False, selectdirection=None,yaxis=dict(title='N Respondnets'),yaxis2=dict(title='Mean Age'),height=350,width=400,title='Top 20 Countries By Respondents and Thier average Age')
